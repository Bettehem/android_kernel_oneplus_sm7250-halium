...
KERNEL_BOOTIMAGE_CMDLINE = androidboot.hardware=qcom androidboot.console=ttyMSM0 androidboot.memcg=1 lpm_levels.sleep_disabled=1 msm_rtb.filter=0x237 service_locator.enable=1 androidboot.usbcontroller=a600000.dwc3 swiotlb=2048 loop.max_part=7 cgroup.memory=nokmem,nosocket reboot=panic_warm console=tty0 droidian.lvm.prefer
...
DEVICE_FULL_NAME = OnePlus Nord (avicii)
...
KERNEL_BOOTIMAGE_DTB_OFFSET = 0x0000000001f00000
...
# recommended.
FLASH_INFO_CPU = Qualcomm Technologies, Inc SDM765G 5G

# Space-separated list of supported device ids as reported by fastboot
FLASH_INFO_DEVICE_IDS = avicii
...
DEB_TOOLCHAIN = linux-initramfs-halium-generic:arm64, binutils-aarch64-linux-gnu, clang-android-6.0-4691093, gcc-4.9-aarch64-linux-android, g++-4.9-aarch64-linux-android, libgcc-4.9-dev-aarch64-linux-android-cross, python-is-python3, clang-android-9.0-r353983c, device-tree-compiler
