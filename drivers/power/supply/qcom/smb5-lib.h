...
#define SKIN_THERMAL_LITTLE_HIGH	40
#define SKIN_THERMAL_PRE_LITTLE_HIGH	39
#define SKIN_THERMAL_MEDIUM		38
...
/* @bsp, Enable external stm6620 ship mode */
...
/* @bsp, usb connector hw auto detection */
...
/* @bsp, 2019/07/05 Battery & Charging porting */
	...
	// Skin therm thresholds when display is OFF
	int			skin_thermal_high_threshold_disp_off;
	int			skin_thermal_pre_high_threshold_disp_off;
	int			skin_thermal_medium_threshold_disp_off;
	int			skin_thermal_normal_threshold_disp_off;
	// Skin therm thresholds when display is ON
	int			skin_thermal_high_threshold_disp_on;
	int			skin_thermal_pre_high_threshold_disp_on;
	int			skin_thermal_little_high_threshold_disp_on;
	int			skin_thermal_pre_little_high_threshold_disp_on;
	...
	int			pd_skin_thermal_pre_high_threshold;
	int			pd_skin_thermal_medium_threshold;
...
/*@bsp, icl set 1A if battery lower than 15%*/
	bool		OTG_ICL_CTRL;
	int			OTG_LOW_BAT;
	int			OTG_LOW_BAT_ICL;
	int			OTG_NORMAL_BAT_ICL;
/* @bsp, add the external ship-mode and connecter temp detect start*/
	int			shipmode_en;
	int			connecter_temp;
	...
	bool			is_skin_thermal_little_high;
	bool			is_skin_thermal_medium;
	int			disconnect_vbus;
	int			vbus_ctrl;
	bool		low_voltage_charger;
/* @bsp, add the external ship-mode and connecter temp detect end*/
...
extern void set_mcu_active(int value);
